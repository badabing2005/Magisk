...
2. Next, download special Magisk build from [releases](https://github.com/badabing2005/Magisk/releases) (stable beta or debug, as you wish). As of this writing this special Magisk is based on **versionCode 30600**, and has module loading disabled but root is enabled, you will need to use this temporarily so that you can fix the bad modules situation.
